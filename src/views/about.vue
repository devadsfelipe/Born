        ...
        <div class="container">
            <div class="row">
                ...
                <div class="about-col-2">
                    ...
                    <div v-else-if="showCertifications" id="certifications" class="tab-contents">
                        <ul>
                            <li><span>MICROSOFT AZURE AZ-900</span><br>Conceitos de nuvem em geral e do Microsoft Azure</li>
                        </ul>
                    </div>
                </div>
            </div>
